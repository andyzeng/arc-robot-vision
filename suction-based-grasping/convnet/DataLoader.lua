...
function DataLoader:getMiniBatch()
    ...
    for sampleIdx = 1,self.batchSize do
        batchColorPaths[sampleIdx] = paths.concat(options.dataPath,'color-input',self.samplePaths[self.shuffleIdx[self.trainIdx]]..'.png')
        batchDepthPaths[sampleIdx] = paths.concat(options.dataPath,'depth-input',self.samplePaths[self.shuffleIdx[self.trainIdx]]..'.png')
        batchLabelPaths[sampleIdx] = paths.concat(options.dataPath,'label',self.samplePaths[self.shuffleIdx[self.trainIdx]]..'.png')

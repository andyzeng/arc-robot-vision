...
* [Baseline Algorithms]() - Matlab implementations of baseline algorithms for detecting grasps directly from 3D point cloud data.
* [Multi-Cam Realsense RGB-D Capture]() - A C++ implementation for streaming and capturing data (RGB-D frames) in real-time using [librealsense](https://github.com/IntelRealSense/librealsense), optimized to avoid IR depth interference for multi-cam setups. Tested on Ubuntu 16.04 with 16 Intel® RealSense™ SR300 Cameras.
...
# Predict Affordances for Suction-Based Grasping
